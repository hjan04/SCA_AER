# Stage 5 Fmax sweep - baseline, tighter period (9.7ns)
...
set RESULT_DIR "$ROOT_DIR/results/baseline_link_9p7"
...
# Fmax sweep point: tighter than the 10.0ns baseline run (which had +0.2ns slack).
