# Stage 5 Fmax sweep - model2 (hysteresis), tighter period (9.7ns)
...
set RESULT_DIR "$ROOT_DIR/results/adaptive_link_model2_9p7"
...
# Fmax sweep point: tighter than the 10.0ns model2 run (which had +0.3ns slack).
