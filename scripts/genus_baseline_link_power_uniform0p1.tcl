...
set RESULT_DIR "$ROOT_DIR/results/baseline_link_power_uniform0p1"
...
syn_map
syn_opt
read_vcd -vcd_scope tb_stage4_compare.gen_baseline.dut "$ROOT_DIR/results/waves/power/baseline_uniform0p1.vcd"
