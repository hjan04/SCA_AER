# Stage 5 Fmax sweep - model2 (hysteresis), tighter period (9.4ns)
...
set RESULT_DIR "$ROOT_DIR/results/adaptive_link_model2_9p4"
...
# Fmax sweep point 2: the 9.7ns run still showed +0.3ns slack, so the true
# critical path is closer to 9.4ns. Targeting that directly.
