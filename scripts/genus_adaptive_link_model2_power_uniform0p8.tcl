...
set RESULT_DIR "$ROOT_DIR/results/adaptive_link_model2_power_uniform0p8"
...
syn_map
syn_opt
read_vcd -vcd_scope tb_stage4_compare.gen_adaptive.dut "$ROOT_DIR/results/waves/power/model2_uniform0p8.vcd"
